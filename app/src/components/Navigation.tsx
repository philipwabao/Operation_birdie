            ...
            <div className="relative px-5 py-2 group">
              ...
              <style>{`
                @keyframes border-gradient-to-purple {
                  0% { border-color: #A7F3D0; } /* Mint */
                  50% { border-color: #38BDF8; } /* Blue */
                  100% { border-color: #9B7BC7; } /* Purple (Stays here) */
                }
              `}</style>

              {/* Subtle Glow Backdrop */}
              <div
                className="absolute inset-0 bg-gradient-to-r from-purple-500/5 to-blue-500/5 blur-md rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              />
